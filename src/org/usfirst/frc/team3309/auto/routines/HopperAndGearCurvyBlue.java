...
public class HopperAndGearCurvyBlue extends AutoRoutine {
	public void routine() throws TimedOutException, InterruptedException {
		...
		this.turnToAngle(-94, 1);
		this.shoot();

		LinkedList<VelocityChangePoint> changePoints2 = new LinkedList<VelocityChangePoint>();
		// do a curvy path to the shooting locations
		changePoints2.add(new VelocityChangePoint(3500, 3500, 0, -94));// 3000
		changePoints2.add(new VelocityChangePoint(1100, 1100, 14000, -94)); // 700
